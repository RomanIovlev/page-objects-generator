...
public class SupportedTypesContainer {
	...
	private void fillSupportedTypesMap() {
		...
		supportedTypesMap.put("datepicker", new ClassAndAnnotationPair(DatePicker.class, FindBy.class));
		supportedTypesMap.put("fileinput", new ClassAndAnnotationPair(FileInput.class, FindBy.class));
		...
		supportedTypesMap.put("textfield", new ClassAndAnnotationPair(TextField.class, FindBy.class));
		supportedTypesMap.put("radiobuttons", new ClassAndAnnotationPair(RadioButtons.class, FindBy.class));
		...
		supportedTypesMap.put("checklist", new ClassAndAnnotationPair(CheckList.class, FindBy.class));
		...
		supportedTypesMap.put("combobox", new ClassAndAnnotationPair(ComboBox.class, JComboBox.class));
		supportedTypesMap.put("dropdown", new ClassAndAnnotationPair(Dropdown.class, JDropdown.class));
		supportedTypesMap.put("droplist", new ClassAndAnnotationPair(DropList.class, JDropList.class));
