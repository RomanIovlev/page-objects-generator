...
public class ValidationContextTest {
    ...
    public void getValidRules(){
        sut.addValidationResult(new ValidationResult(true, new LocatorExistenceValidator(), ruleWithCss));
        sut.addValidationResult(new ValidationResult(true, new LocatorExistenceValidator(), ruleWithXpath));
        sut.addValidationResult(new ValidationResult(false, new LocatorExistenceValidator(), ruleNoLocator));
